...
WebUI.callTestCase(findTestCase('Commons/Steps_Navigate User Management'), [:], FailureHandling.STOP_ON_FAILURE)

WebUiBuiltInKeywords.click(findTestObject('User Management/Btn_Add User'))

WebUiBuiltInKeywords.delay(3)

WebUiBuiltInKeywords.click(findTestObject('User Management/Btn_Close'))
